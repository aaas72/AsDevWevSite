...
export default function Navbar() {
  ...
  const navItemsClasses = `nav-items-container flex items-center rounded-full backdrop-blur-xl transition-all duration-500
    p-1 sm:p-1.5 gap-1 sm:gap-1.5 md:gap-2 w-fit
    ${
      isLight
  ...
  return (
    <nav aria-label="Primary navigation" className="navbar w-full fixed top-0 z-50 transition-all duration-300">
      <div className="navbar-container relative max-w-[1440px] min-h-[50px] xs:min-h-[55px] sm:min-h-[65px] md:min-h-[75px] lg:min-h-[85px] mx-auto flex items-center justify-between px-3 xs:px-4 sm:px-6 md:px-8 lg:px-10">
        
        {/* Left: Logo */}
        <div className="flex-1 flex justify-start items-center min-w-0">
          <Link to="/" className={logoClasses} title="Abdellah Sheikh">
        ...
        {/* Center: Desktop Navigation Capsule (Exactly Centered) */}
        <div className="hidden sm:flex absolute left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 z-20 pointer-events-auto">
        ...
        {/* Right: Desktop Social Links & Mobile Menu Button */}

    ...
    <div className="space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-4 max-h-[70vh] overflow-y-auto pr-2 custom-scrollbar">
          {messages.length === 0 ? (
            <div className="p-12 text-center bg-[#1A1A1A]/40 border border-dashed border-white/10 rounded-[2.5rem]">
              ...
              <div 
                ...
                className={`p-6 rounded-2xl border transition-all cursor-pointer group relative ${
                  selectedMessage?.id === msg.id 
                    ...
                    : "bg-[#1A1A1A]/40 border-white/5 hover:border-white/10 text-[#C5C5C5]"
                }`}
              >
                {!msg.is_read && (
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="mt-4 flex items-center justify-between">
                    ...
                    <Button 
                      ...
                      className={`opacity-0 group-hover:opacity-100 ${selectedMessage?.id === msg.id ? "text-red-500 hover:bg-red-50" : "text-[#919191] hover:text-red-400"}`}
                    >
                      <FiTrash2 />
                    </Button>
                  </div>
        ...
        <div className="lg:col-span-7">
          {selectedMessage ? (
            <div className="bg-[#1A1A1A]/40 border border-white/5 rounded-[2.5rem] p-10 space-y-10 min-h-[60vh] backdrop-blur-md">
            ...
            <div className="h-[60vh] border border-dashed border-white/10 rounded-[2.5rem] flex flex-col items-center justify-center text-center p-12 bg-[#1A1A1A]/40">
